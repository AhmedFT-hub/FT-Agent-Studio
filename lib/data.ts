...
export const agents: Agent[] = [
  {
    ...
    category: "Other",
    tags: ["Compliance", "Validation", "Regulatory", "Quality Control"],
    status: "Live",
  ...
  },
  {
    ...
    category: "Tracking",
    tags: ["Risk Management", "Real-time Alerts", "Geofencing", "Safety"],
    status: "Live",
  ...
  },
  {
    ...
    tags: ["Predictive Analytics", "Delay Prevention", "ML Models", "ETA Optimization"],
    status: "Live",
  ...
  },
  {
    ...
    category: "Planning",
    tags: ["Load Optimization", "Driver Assignment", "Capacity Management", "Route Matching"],
    status: "Live",
  ...
  },
  {
    ...
    category: "Planning",
    tags: ["Load Optimization", "3D Planning", "Space Utilization", "Cost Reduction"],
    status: "Live",
  ...
  },
  {
    ...
    tags: ["Operations Management", "Real-time Monitoring", "Dashboard", "Alert System"],
    status: "Live",
  ...
  },
  {
    ...
    category: "Planning",
    tags: ["Indent Management", "Auto-allocation", "Transporter Matching", "Smart Routing"],
    status: "Beta",
  ...
  },
  {
    ...
    category: "Finance",
    tags: ["Rate Negotiation", "Price Optimization", "Market Analysis", "Cost Savings"],
    status: "Experimental",
  ...
  },
  {
    ...
    category: "Intelligence",
    tags: ["Benchmarking", "Market Comparison", "Rate Analysis", "Performance Metrics"],
    status: "Live",
    vercelUrl: "https://freight-intelligence-hub.vercel.app",
    imageUrl: "/agents/rate-intelligence.svg",
    lastUpdated: "Nov 2025",
